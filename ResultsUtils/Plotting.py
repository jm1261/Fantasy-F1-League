...
def plotting_colors(format_dir: str,
    ...
    Function Details
    ================
    Determine plotting colors based on input. Takes data from format
    dictionaries to create the marker and line colors for the teams and drivers
    on the plot.
    ...
    context, entity: string
        Context for plotting (e.e., 'driver', 'constructor', 'team', 'manager',
        'perk'). Specific entity for which colors are being selected.
    ...
    def get_format_dict(subdir: str,
        ...
        Parameters
        ----------
        subdir, context: string
            Path to the main formats directory. The specific entity (driver,
            team, manager, etc.) for which the format is being retrieved.

        Returns
        -------
        dict
            Format dictionary containing the colors and styles for the
            specified entity.
    ...
    logger.info(f'Getting plot colours for {context} using {subdir} path')
